...
public class Checklisten_Editor_Truck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=13;i< sprache.length; i++) {
            ...
            if (sprache[i].equals("(de)")) {
                ...
                Thread.sleep(2000);
                checklisten_editor_page.choiceChecklisteAnahmeProtokolForLKW();
                Thread.sleep(2000);
...
//Change Outlet
                ...
                Thread.sleep(2000);
                checklisten_editor_page.choiceChecklisteAnahmeProtokolForMarktLKW();
                Thread.sleep(2000);
                ...
                checklisten_editor_page.clickOnMarktRubrikAnlegenLKW();
                Thread.sleep(2000);
                ...
                checklisten_editor_page.clickOnBetriebPruefrikLKW();
                Thread.sleep(2000);
