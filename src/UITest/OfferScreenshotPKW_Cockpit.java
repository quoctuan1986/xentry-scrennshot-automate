...
public class OfferScreenshotPKW_Cockpit {
...
//Change Oulet name
         ...
         //   screenshot.madeScreenshot(UIConstants.XP_START_PAGE, sprache[i]);
            ...
            Thread.sleep(5000);
            /*
            serviceManagement_2_page.textReplaceCustomerNameInTheVehicle();
            serviceManagement_2_page.textReplaceFinListeNameInTheVehicle();
            serviceManagement_2_page.textReplaceKennzeichenInTheVehicleList();
            serviceManagement_2_page.textReplaceOutletName();
            serviceManagement_2_page.textReplaceServiceName();
            serviceManagement_2_page.textReplaceUserName();

            */

            //
            serviceManagement_2_page.textReplaceCustomerNameInTheVehicle_1();
            serviceManagement_2_page.textReplaceFinListeNameInTheVehicle_1();
            serviceManagement_2_page.textReplaceKennzeichenInTheVehicleList_1();
            serviceManagement_2_page.textReplaceOutletName_1();
            serviceManagement_2_page.textReplaceServiceName_1();
            serviceManagement_2_page.textReplaceUserName_1();
            ...
            serviceManagement_2_page.textReplaceUserName();
            serviceManagement_2_page.textReplaceOutletName();
            serviceManagement_2_page.textReplaceInOfferFIN();
            */
            ...
            serviceManagement_2_page.textReplaceUserName_1();
            serviceManagement_2_page.textReplaceOutletName_1();
            serviceManagement_2_page.textReplaceInOfferFIN_1();
            //
            ...
            /*
            serviceManagement_2_page.textReplaceInOfferCustomerData();
            */

            //
            serviceManagement_2_page.textReplaceInOfferCustomerData_1();
            //
            ...
            driver.get("https://xentry-int2.daimler.com/order/service-reception/1305501");
            ...
            serviceManagement_2_page.textReplaceUserName();
            serviceManagement_2_page.textReplaceOutletName();
            serviceManagement_2_page.textReplaceInAuftragManagement();
            */

            //
            serviceManagement_2_page.textReplaceUserName_1();
            serviceManagement_2_page.textReplaceOutletName_1();
            serviceManagement_2_page.textReplaceInAuftragManagement_1();
            //
            screenshot.madeScreenshot("Auftragmanagement", sprache[i]);
