...
public class ScreenshotAuftragManagement_Truck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=8;i<sprache.length; i++) {
...
//Change Oulet name
           ...
           // auftrag_management_page.sortiertArchivNachTermin();
            ...
            Thread.sleep(2000);
            //auftrag_management_page.scrollDownThePageToJobInTheVorgangListe("Test_Truck");
           // auftrag_management_page.clickOnTextJobsInTheJobsListe();
           ...
           // auftrag_management_page.clickOnTheArchivJob(UIConstants.TRUCK_FIN_2);
            auftrag_management_page.waitForSpinnerNotAppears();
